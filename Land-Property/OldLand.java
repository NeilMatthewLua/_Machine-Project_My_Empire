//Old implementation of Land
public class OldLand {
     ...
     */
    public OldLand(String strName, String strLandType){
     ...
     */
    public OldLand(String strName, String strLandType, double dPrice){
        this.strName  = strName;
        this.strLandType = strLandType;
        this.dPrice = dPrice;
        dMultiplier = 1;
    ...
    public void triggerEvent(Player player, GameBoard gameBoard){
        ...
        if(strLandType.equals("property") || strLandType.equals("railroad") || strLandType.equals("utility")){
            ...
            System.out.println("Payment for " + getName() + " space is: $" + dPayment);
